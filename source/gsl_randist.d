...
double gsl_ran_dirichlet_pdf (const size_t K, const(double)* alpha, double* theta);
double gsl_ran_dirichlet_lnpdf (const size_t K, const(double)* alpha, double* theta);
...
double gsl_ran_multinomial_pdf (const size_t K, const(double)* p, uint* n);
double gsl_ran_multinomial_lnpdf (const size_t K, const(double)* p, uint* n);
